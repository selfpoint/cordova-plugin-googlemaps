...
if (!window.Promise) {
  window.Promise = require('@parrino/cordova-plugin-googlemaps.Promise');
}

var common = require('@parrino/cordova-plugin-googlemaps.Common'),
  Map = require('@parrino/cordova-plugin-googlemaps.Map'),
  StreetViewPanorama = require('@parrino/cordova-plugin-googlemaps.StreetViewPanorama');
